...
class PledgesControllerTest < ActionController::TestCase
  ...
  test "should create pledge" do
    assert_difference('Pledge.count') do
      post :create, pledge: { amount: @pledge.amount, anonymous: @pledge.anonymous, matching: @pledge.matching }
    end
  ...
  test "should update pledge" do
    put :update, id: @pledge, pledge: { amount: @pledge.amount, anonymous: @pledge.anonymous, matching: @pledge.matching }
    assert_redirected_to pledge_path(assigns(:pledge))
  end
